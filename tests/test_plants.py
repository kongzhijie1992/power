...
def _sample_raw():
    return pd.DataFrame(
        [
            {"name": "Gas CCGT A", "country": "DE", "energy_source": "Natural gas", "technology": "Combined cycle", "capacity": 400, "chp": "No", "commissioned": 2015, "eic_code": "PLANTA"},
            {"name": "Coal Plant B", "country": "DE", "energy_source": "Hard coal", "technology": "Steam", "capacity": 600, "chp": "Yes", "commissioned": 2005, "eic_code": "PLANTB"},
            {"name": "Lignite Plant C", "country": "LU", "energy_source": "Lignite", "technology": "Steam", "capacity": 300, "chp": None, "commissioned": 2010, "eic_code": "PLANTC"},
            {"name": "Nuclear X", "country": "DE", "energy_source": "Nuclear", "technology": "PWR", "capacity": 1300, "chp": None, "commissioned": 1990, "eic_code": "NUC"},
        ]
    )
...
def test_enrich_thermal_plants_filters_and_enriches():
    ...
    for col in ["capacity_mw", "efficiency", "co2_intensity", "vom", "fuel", "stack_type"]:
