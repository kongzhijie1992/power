...
class TestFullPipeline(unittest.TestCase):
    ...
    def test_full_pipeline_synthetic_data(self):
        ...
        # 1. Ingest (synthetic)
        prices = synthetic_area_series('DE', days=90)  # Use 90 days for seasonal_naive_forecast
        ...
        # 3. Backtest
        results = walk_forward_backtest(prices, seasonal_naive_forecast, train_window_days=40, horizon_days=7)
    ...
    def test_uc_dispatch_integration(self):
        ...
        self.assertGreater(dispatch_total, forecast_total * 0.9)  # Should meet most demand
...
class TestPipelineConsistency(unittest.TestCase):
    ...
    def test_backtest_determinism(self):
        ...
        results1 = walk_forward_backtest(prices, seasonal_naive_forecast, train_window_days=40, horizon_days=7)
        results2 = walk_forward_backtest(prices, seasonal_naive_forecast, train_window_days=40, horizon_days=7)
