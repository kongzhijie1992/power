...
def main():
    ...
    units = [
        {'name': 'Nuclear', 'p_min': 1000, 'p_max': 3000, 'marginal_cost': 10.0, 'startup_cost': 1000.0},
        {'name': 'Coal', 'p_min': 500, 'p_max': 4000, 'marginal_cost': 50.0, 'startup_cost': 500.0},
        {'name': 'Gas', 'p_min': 0, 'p_max': 5000, 'marginal_cost': 70.0, 'startup_cost': 300.0},
        {'name': 'Wind', 'p_min': 0, 'p_max': 2000, 'marginal_cost': 0.0, 'startup_cost': 0.0},
    ]
